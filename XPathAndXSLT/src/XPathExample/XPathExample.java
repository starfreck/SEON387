...
public class XPathExample
{
    public static void main(String[] args) throws Exception 
    {
        ...
        Document doc = builder.parse("src/XPathExample/inventory.xml");
        ...
        System.out.println("6) Get book title added in last node (use of last())");
 
        // 6) Get book title added in last node (use of last())
        ...
        System.out.println("8) Count all books titles  (use of count())");
 
        // 8) Count all books titles (use of count())
        expr = xpath.compile("count(//book/title)");
        result = expr.evaluate(doc, XPathConstants.NUMBER);
        Double count = (Double) result;
        System.out.println(count.intValue());
 
        System.out.println("9)  Get first book title which was writer by Neal Stephenson (use of concat())");
		
	// 9) Get first book title which was writer by Neal Stephenson (use of concat())
        expr = xpath.compile("concat('The book ',//book[author='Neal Stephenson']/title/text(),' was written by Neal Stephenson')");
        result = expr.evaluate(doc, XPathConstants.STRING);
        System.out.println(result);
		
		
	System.out.println("10) Get book titles with writer name start with Neal (use of starts-with())");
		
        // 10) Get book titles with writer name start with Neal (use of starts-with())
        ...
        System.out.println("11) Get book titles with writer name containing Niven (use of contains())");
 
        // 11) Get book titles with writer name containing Niven (use of contains())
        ...
        System.out.println("12) Get book titles written by Neal Stephenson");
 
        // 12) Get book titles written by Neal Stephenson
        ...
        System.out.println("13) Get count of book titles written by Neal Stephenson");
 
        // 13) Get count of book titles written by Neal Stephenson
        expr = xpath.compile("count(//book[author='Neal Stephenson'])");
        result = expr.evaluate(doc, XPathConstants.NUMBER);
        count = (Double) result;
        System.out.println(count.intValue());
 
        System.out.println("14) Reading comment node ");
 
        // 14) Reading comment node
